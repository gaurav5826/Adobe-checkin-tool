...
How the Check-in writing should read. Adjust to taste.

## Tone
- Soft, professional, realistic. No inflated or "heavy" words that read as
  unrealistic. Show visibility without bragging.
- State things once, calmly. Confidence, not defensiveness.

## What goes where
- **Answers (the form):** narrative prose — scope and outcomes. Lead with
  impact ("delivered X, adopted by customers, ahead of deadline"), not activity.
